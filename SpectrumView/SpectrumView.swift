...
@IBDesignable public class SpectrumView: UIView {
    /// 线条宽度
    ...
    /// 线条的间隔
    @IBInspectable public var lineSpace: Float = 10 {
        willSet { self.updateLines() }
    }
    ...
    /// 中间的间隔
    @IBInspectable public var middlePadding: Float = 40.0 {
        willSet { self.updateLines() }
    }
    
    /// 最大条数
    @IBInspectable public var maxLineCount: Int = 100 {
        willSet { self.updateLines() }
    }
...
extension SpectrumView {
    func getLineLayer() -> CAShapeLayer {
        ...
        line.lineCap = CAShapeLayerLineCap.butt
